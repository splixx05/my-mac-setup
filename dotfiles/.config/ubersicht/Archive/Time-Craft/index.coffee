...
centreWidget = false;  # true / false (true=centre , false=top)
...
update: (output, domEl) ->
  ...
  formattedDate = today.toLocaleString('de-CH', { month: 'long', day: 'numeric' })
  ...
  # $(domEl).find('.date').text("#{formattedDate}")     # If you want to show the entire date uncomment this line
