# command: "osascript mail-count-read.widget/scripts/mail.sc"
command: "python imap-email-count.widget/scripts/imap.py"
...
render: -> """
<span class='mail-count'>asd</span>
...
update: (numberOfUnreadMails, domEl) ->
  $(domEl).find('.mail-count').html(" #{numberOfUnreadMails}")
