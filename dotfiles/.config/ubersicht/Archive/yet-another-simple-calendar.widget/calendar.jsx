...
const WIDTH = 307; // width of the widget
const TOP = 250; // top margin
const LEFT = 70; // left margin
const BOTTOM = 24; // bottom margin
const BACKGROUND_COLOR = "#283457";
const CURR_COLOR = "#FF6B6B";
const FOREGROUND_COLOR = "#B4C9FF";
const DONE_COLOR = "#3f486b";
const ACC_COLOR = "#00c6e1";
const HIGH_COLOR = "#A0CFFF";
  ...
  lines.forEach((line) => {
    ...
    if (result === null) {
      ...
      events.push({
        ...
        //   ? "Google Meet call"
        //   : result[5].includes("OpenTargets weekly call")
        //   ? "Teams call"
        //   : result[5].includes("cGenTar")
        //   ? "Google Meet call"
        //   : result[5].includes("biweekly")
        //   ? "Google Meet call"
        //   : result[5].includes("Giulia")
        //   ? "Meeting without link"
        //   : result[5].includes("Nabeel")
        //   ? "Zoom call"
        //   : result[5].includes("SAN ONCO")
        //   ? "Zoom call"
        //   : result[5],
